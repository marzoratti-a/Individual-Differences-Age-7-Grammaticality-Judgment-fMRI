  subject = num2str(d(i).name,'%02d'); % Zero-pads each number so that the subject ID is 2 characters long
    ...
    %%%%%%%%%%
    matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = [subject,'_Gramruns'];
    ...
    matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(1) = cfg_dep(['Named File Selector: ',subject,'_Gramruns(1) - Files'], substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
    matlabbatch{2}.spm.spatial.realign.estwrite.data{2}(1) = cfg_dep(['Named File Selector: ',subject,'_Gramruns(2) - Files'], substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{2}));
  ...
  % MODULE 3: Segmenting
    matlabbatch{3}.spm.spatial.preproc.channel.vols = {['D:\ds003604\',subject,'\ses-7\anat\',subject,'_ses-7_acq_T1w.nii,1']};
    ...
    matlabbatch{4}.spm.util.imcalc.outdir = {['D:\ds003604\',subject,'\ses-7\anat']};
    ...
    matlabbatch{5}.spm.util.imcalc.outdir = {['D:\ds003604\',subject,'\ses-7\anat']};
  ...
  % MODULE 8: Smooth
    ...
    matlabbatch{9}.cfg_basicio.file_dir.file_ops.cfg_file_split.name = 'run1run2GramFileSplit';
    ...
    matlabbatch{10}.spm.stats.fmri_spec.dir = {['D:\ds003604\',subject,'\ses-7\1stLevelG']};
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).scans(1) = cfg_dep('File Set Split: run1run2GramFileSplit (1)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{1}));
    % Selects Session 1 files from File Set Split Module
    % Conditions
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(1).name = 'G_Ctrl';
    data_g_ctrl_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_Ctrl.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(1).onset = data_g_ctrl_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(1).duration = data_g_ctrl_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(2).name = 'G_F';
    data_g_f_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_F.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(2).onset = data_g_f_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(2).duration = data_g_f_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(3).name = 'G_G';
    data_g_g_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_G.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(3).onset = data_g_g_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(3).duration = data_g_g_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(4).name = 'G_P';
    data_g_p_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_P.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(4).onset = data_g_p_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(4).duration = data_g_p_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).scans(1) = cfg_dep('File Set Split: run1run2GramFileSplit (2)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{2}));
    % Selects Session 2 files from File Set Split Module
    % Conditions
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(1).name = 'G_Ctrl';
    data_g_ctrl_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_Ctrl_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(1).onset = data_g_ctrl_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(1).duration = data_g_ctrl_run2(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(2).name = 'G_F';
    data_g_f_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_F_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(2).onset = data_g_f_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(2).duration = data_g_f_run2(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(3).name = 'G_G';
    data_g_g_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_G_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(3).onset = data_g_g_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(3).duration = data_g_g_run2(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(4).name = 'G_P';
    data_g_p_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_G_P_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(4).onset = data_g_p_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(4).duration = data_g_p_run2(:,2);
    ...
    matlabbatch{12}.spm.stats.con.consess{1}.tcon.name = 'G_F-Ctrl';
