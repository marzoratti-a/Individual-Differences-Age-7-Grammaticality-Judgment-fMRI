  subject = num2str(d(i).name,'%02d'); % Zero-pads each number so that the subject ID is 2 characters long
    ...
    %%%%%%%%%%
    matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = [subject,'_Plausruns'];
    matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                        {['D:\agespec_data\',subject,'\ses-7\func\',subject,'_ses-7_task-Plaus_acq_run-01_bold.nii']}
                                                                        {['D:\agespec_data\',subject,'\ses-7\func\',subject,'_ses-7_task-Plaus_acq_run-02_bold.nii']}
                                                                        }';
    % MODULE 2: Realign (Estimate & Reslice)
    matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(1) = cfg_dep(['Named File Selector: ',subject,'_Plausruns(1) - Files'], substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
    matlabbatch{2}.spm.spatial.realign.estwrite.data{2}(1) = cfg_dep(['Named File Selector: ',subject,'_Plausruns(2) - Files'], substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{2}));
  ...
  % MODULE 3: Segmenting
    matlabbatch{3}.spm.spatial.preproc.channel.vols = {['D:\agespec_data\',subject,'\ses-7\anat_P\',subject,'_ses-7_acq_T1w.nii,1']};
    ...
    matlabbatch{4}.spm.util.imcalc.outdir = {['D:\agespec_data\',subject,'\ses-7\anat_P']};
    ...
    matlabbatch{5}.spm.util.imcalc.outdir = {['D:\agespec_data\',subject,'\ses-7\anat_P']};
  ...
  % MODULE 8: Smooth
    ...
    matlabbatch{9}.cfg_basicio.file_dir.file_ops.cfg_file_split.name = 'run1run2PlausFileSplit';
    ...
    matlabbatch{10}.spm.stats.fmri_spec.dir = {['D:\agespec_data\',subject,'\ses-7\1stLevelP']};
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).scans(1) = cfg_dep('File Set Split: run1run2PlausFileSplit (1)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{1}));
    % Selects Session 1 files from File Set Split Module
    % Conditions
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(1).name = 'P_Ctrl';
    data_p_ctrl_run1 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_Ctrl.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(1).onset = data_p_ctrl_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(1).duration = data_p_ctrl_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(2).name = 'P_I';
    data_p_i_run1 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_I.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(2).onset = data_p_i_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(2).duration = data_p_i_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(3).name = 'P_S';
    data_p_s_run1 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_S.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(3).onset = data_p_s_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(3).duration = data_p_s_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(4).name = 'P_W';
    data_p_w_run1 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_W.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(4).onset = data_p_w_run1(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(1).cond(4).duration = data_p_w_run1(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).scans(1) = cfg_dep('File Set Split: run1run2PlausFileSplit (2)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{2}));
    % Selects Session 2 files from File Set Split Module
    % Conditions
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(1).name = 'P_Ctrl';
    data_p_ctrl_run2 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_Ctrl_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(1).onset = data_p_ctrl_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(1).duration = data_p_ctrl_run2(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(2).name = 'P_I';
    data_p_i_run2 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_I_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(2).onset = data_p_i_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(2).duration = data_p_i_run2(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(3).name = 'P_S';
    data_p_s_run2 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_S_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(3).onset = data_p_s_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(3).duration = data_p_s_run2(:,2);
    ...
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(4).name = 'P_W';
    data_p_w_run2 = load(['D:\agespec_data\',subject '\ses-7\func\timing\',subject,'_ses-7_P_W_2.txt']);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(4).onset = data_p_w_run2(:,1);
    matlabbatch{10}.spm.stats.fmri_spec.sess(2).cond(4).duration = data_p_w_run2(:,2);
   ...
   % Selects SPM.mat file from model estimation step
    matlabbatch{12}.spm.stats.con.consess{1}.tcon.name = 'P_I-Ctrl';
