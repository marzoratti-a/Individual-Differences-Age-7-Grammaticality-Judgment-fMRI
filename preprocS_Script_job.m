 subject = num2str(d(i).name,'%02d'); % Zero-pads each number so that the subject ID is 2 characters long
   %%%%%%%%%%
   matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = [subject,'_Semrun1run2'];
   ...
   matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(1) = cfg_dep(['Named File Selector: ',subject,'_Semrun1run2(1) - Files'], substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
   matlabbatch{2}.spm.spatial.realign.estwrite.data{2}(1) = cfg_dep(['Named File Selector: ',subject,'_Semrun1run2(2) - Files'], substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{2}));
 ...
 % MODULE 4: Coregister (Estimate & Reslice)
   ...
   matlabbatch{4}.spm.spatial.coreg.estwrite.source = {['D:\ds003604\' subject '\ses-7\anat_S\',subject,'_ses-7_acq_T1w.nii']};
   ...
   % MODULE 5: Segment
   matlabbatch{5}.spm.spatial.preproc.channel.vols = {['D:\ds003604\',subject,'\ses-7\anat_S\',subject,'_ses-7_acq_T1w.nii,1']};
   ...
   matlabbatch{8}.cfg_basicio.file_dir.file_ops.cfg_file_split.name = 'run1run2SemFileSplit';
   ...
   matlabbatch{9}.spm.stats.fmri_spec.dir = {['D:\ds003604\',subject,'\ses-7\1stLevelS']};
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).scans(1) = cfg_dep('File Set Split: run1run2SemFileSplit (1)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{1}));
   % Selects Session 1 files from File Set Split Module
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(1).name = 'S_Ctrl';
   data_s_ctrl_run1 = load(['D:\ds003604\',subject '\ses-7\func\timing\',subject,'_ses-7_S_Ctrl.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(1).onset = data_s_ctrl_run1(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(1).duration = data_s_ctrl_run1(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(2).name = 'S_H';
   data_s_h_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_H.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(2).onset = data_s_h_run1(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(2).duration = data_s_h_run1(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(3).name = 'S_L';
   data_s_l_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_L.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(3).onset = data_s_l_run1(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(3).duration = data_s_l_run1(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(4).name = 'S_U';
   data_s_u_run1 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_U.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(4).onset = data_s_u_run1(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(4).duration = data_s_u_run1(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).scans(1) = cfg_dep('File Set Split: run1run2SemFileSplit (2)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{2}));
   % Selects Session 2 files from File Set Split Module
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(1).name = 'S_Ctrl';
   data_s_ctrl_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_Ctrl_2.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(1).onset = data_s_ctrl_run2(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(1).duration = data_s_ctrl_run2(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(2).name = 'S_H';
   data_s_h_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_H_2.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(2).onset = data_s_h_run2(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(2).duration = data_s_h_run2(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(3).name = 'S_L';
   data_s_l_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_L_2.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(3).onset = data_s_l_run2(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(3).duration = data_s_l_run2(:,2);
   ...
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(4).name = 'S_U';
   data_s_u_run2 = load(['D:\ds003604\' subject '\ses-7\func\timing\',subject,'_ses-7_S_U_2.txt']);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(4).onset = data_s_u_run2(:,1);
   matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(4).duration = data_s_u_run2(:,2);
   ...
   matlabbatch{11}.spm.stats.con.consess{1}.tcon.name = 'S_H-Ctrl';
